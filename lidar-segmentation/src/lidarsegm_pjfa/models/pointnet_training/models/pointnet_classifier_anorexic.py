...
class STN3d(nn.Module):
    def __init__(self):
        ...
        self.conv3 = torch.nn.Conv1d(128, 256, 1) #torch.nn.Conv1d(128, 1024, 1)
        self.fc1 = nn.Linear(256, 128) #nn.Linear(1024, 512)
        self.fc2 = nn.Linear(128, 64) #nn.Linear(512, 256)
        self.fc3 = nn.Linear(64, 9) #n.Linear(256, 9)
        self.relu = nn.ReLU()

        self.bn1 = nn.BatchNorm1d(64)
        self.bn2 = nn.BatchNorm1d(128)
        self.bn3 = nn.BatchNorm1d(256) #nn.BatchNorm1d(1024)
        self.bn4 = nn.BatchNorm1d(128) #nn.BatchNorm1d(512)
        self.bn5 = nn.BatchNorm1d(64) #nn.BatchNorm1d(256)
...
class PointNetClassifier(nn.Module):
    def __init__(self, k = 3):
        ...
        self.fc1 = nn.Linear(256, 128) # nn.Linear(1024, 512)
        self.fc2 = nn.Linear(128, 64) # nn.Linear(512, 256)
        self.fc3 = nn.Linear(64, k) #nn.Linear(256, k)
        self.bn1 = nn.BatchNorm1d(128) #nn.BatchNorm1d(512)
        self.bn2 = nn.BatchNorm1d(64) #nn.BatchNorm1d(256)
        self.relu = nn.ReLU()
